const ExpertiesSection = () => {
  return (
    <div className="flex flex-col py-[100px] gap-[100px] text-[#000000]">
      <div className="flex flex-col gap-[60px] text-center w-full items-center">
        ...
        <div className="sm:grid sm:grid-cols-2 flex flex-col justify-center items-center gap-6  w-full px-[18px] place-items-center max-w-fit">
          <div className="flex items-center rounded-[20px] border border-[#EEEEEE] h-[96px] p-6 gap-5 xl:max-w-[484px] w-full">
        ...
        <div className="flex flex-col gap-[32px] sm:gap-[60px] text-center">
          <div className="flex flex-col justify-center items-center gap-6 sm:gap-[32px]">
          ...
          <div className="flex gap-2.5 bg-[#FFB800] py-2.5 px-4 sm:px-6 rounded-xl  sm:rounded-2xl w-max items-center text-center mx-auto hover-gradient active:sm:px-4 active:px-3">
