...
const Navbar = ({ aboutRef, infoRef, workRef }: Props) => {
  ...
  return (
    <div className=" top-0 left-0 w-full bg-white shadow-md px-4 sm:px-[120px] py-3 h-[56px] sm:h-[70px] border-b border-gray-200 z-[100]  sticky">
      ...
      <div
        className={`w-screen h-screen top-0 left-0 absolute bg-black bg-opacity-80 ${
      ...
      >
        <div
          className={`${
            showContactInfo ? "absolute" : "hidden"
          } flex z-[100] flex-col mx-5 w-full max-w-[520px] bg-white rounded-[16px] shadow-[0px_0px_20px_0px_#0000001F] right-[100px] top-20
`}
        >
          <div className="p-4 font-medium text-[20px] text-black flex justify-between items-center  border-b border-[#E8E8E8] ">
            <p>Sanket Patekar</p>
            <img
              src="/icons/cross.svg"
              alt=""
